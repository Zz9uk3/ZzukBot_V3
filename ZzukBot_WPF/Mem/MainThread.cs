...
{
    /// <summary>
    ///     Class to help executing code in the mainthread
    /// </summary>
    [App.Singleton]
    public sealed class MainThread
    {
        ...
        ///     The instance.
        /// </value>
        public static MainThread Instance { get; } = new MainThread();
        ...
        internal void Send(Keys parKey, KeySender.KeyModifier parKeyModifier)
        {
            WinImports.SendMessage(_hWnd, (uint) parKeyModifier, (int) parKey, 0);
        }
