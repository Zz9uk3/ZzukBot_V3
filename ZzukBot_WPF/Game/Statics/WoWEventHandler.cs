...
namespace ZzukBot.Game.Statics
{
    ...
    public sealed class WoWEventHandler
    {
        ...
        private WoWEventHandler()
        {
            ...
            SignalEvent_0Hook.Instance.OnNewEventSignal += EvaluateEvent;
            SignalEventHook.Instance.OnNewEventSignal += EvaluateEvent;
        }
        ...
        {
            internal ChatMessageArgs(Enums.ChatSenderType unitType, string chatTag, string unitName, string chatChannel,
                string message)
            {
                UnitType = unitType;
                ChatTag = chatTag;
            ...
            public Enums.ChatSenderType UnitType { get; private set; }
        ...
        public class OnCtmArgs : EventArgs
        {
            ...
            /// <summary>
            ///     The Position of the Ctm as Location
            /// </summary>
