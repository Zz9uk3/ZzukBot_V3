...
namespace ZzukBot.Game.Statics
{
    ...
    public struct Camera
    {
        ...
        public Location CameraPosition { get; set; }
    ...
    public class DirectX
    {
        ...
        private SharpDX.Direct3D9.Device _device;
        ...
        public Camera GetCurrentCamera()
        {
            ...
            return new Camera
            {
                ...
                CameraPosition = new Location(xyz.X, xyz.Y, xyz.Z),
                FarClip = farClip,
                FieldOfView = fov,
                NearClip = nearClip,
        ...
        /// <returns></returns>
        public Vector2 World2Screen(Location worldPosition)
        {
            var worldMatrix = Matrix.Identity;
            var cam = GetCurrentCamera();
            var pos = new Vector3(worldPosition.X, worldPosition.Y, worldPosition.Z);
