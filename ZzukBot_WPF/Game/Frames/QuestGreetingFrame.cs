    ...
    public sealed class QuestGreetingFrame
    {
        ...
        private QuestGreetingFrame()
        {
            ...
            for (var i = 0; i < availableQuestsCount; i++)
            {
                ...
                _Quests.Add(new QuestOptionInterface(id, name, Enums.QuestGossipState.Available));
            }
            ...
            for (var i = 0; i < activeQuestsCount; i++)
            {
                ...
                _Quests.Add(new QuestOptionInterface(id, name, Enums.QuestGossipState.Accepted));
            }
        }
