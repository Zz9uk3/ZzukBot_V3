...
namespace ZzukBot.Game.Frames
{
    ...
    public sealed class QuestFrame
    {
        ...
        /// <value>
        /// </value>
        public static bool IsOpen => Instance != null && Instance.QuestFrameState != Enums.QuestFrameState.Greeting;
        ...
        /// </value>
        public Enums.QuestFrameState QuestFrameState
        {
            get
            {
                var tmp = 0xBE0818.ReadAs<int>();
                return (Enums.QuestFrameState) tmp;
            }
        }
        ...
        public int QuestFrameId
        {
            get
            {
                if (QuestFrameState == Enums.QuestFrameState.Greeting) return 0;
        ...
        public bool Proceed()
        {
            ...
            {
                case Enums.QuestFrameState.Accept:
                    Lua.Instance.Execute("QuestFrameAcceptButton:Click()");
                    return true;

                case Enums.QuestFrameState.Continue:
        ...
        {
            if (QuestFrameState != Enums.QuestFrameState.Complete) return;
            if (parReward == null)
            {
