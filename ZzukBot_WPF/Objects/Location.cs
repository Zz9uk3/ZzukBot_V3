...
namespace ZzukBot.Objects
{
    ...
    public class Location
    {
        ...
        /// </summary>
        /// <returns></returns>
        public float DistanceToPlayer() => GetDistanceTo(ObjectManager.Instance.Player.Position);
        ...
        /// <param name="distance"></param>
        /// <returns></returns>
        public bool InRangeTo(WoWUnit unit, float distance = 5f) => InRangeTo(unit.Position, distance);
